...
cn-brave-hopper      linked     online                2026-07-01   (this machine)
cn-dreamy-lovelace   linked     offline               2026-07-14
cn-frosty-turing     unlinked   offline               2026-06-02
...
Once two machines are logged into the same workspace they share a namespace and
can address each other, which is the foundation for running a single Peppy stack
across both. See [Federation](/advanced_guides/federation/).

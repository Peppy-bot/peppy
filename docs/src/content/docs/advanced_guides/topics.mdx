...
| Cardinality     | Valid unique targets | Slot kinds it is valid on       | Omitted binding |
| --------------- | -------------------- | ------------------------------- | --------------- |
| `one` / omitted | exactly 1            | producer, observer, participant | error           |
| `zero_or_one`   | 0 or 1               | producer, observer, participant | error: link it, or write it `{ vacant: "<why>" }` |
| `one_or_more`   | 1 or more            | producer, observer, participant | error           |
| `zero_or_more`  | 0 or more            | producer, observer, participant | empty set       |

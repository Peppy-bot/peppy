...
[`zenoh.managed.federation.connect_timeout_secs`](/advanced_guides/daemon_config/#zenohmanagedfederation-router-federation).
...
`peppy federation remove platform-backend` performs the same logout operation,
including its warning and confirmation. See [Server federation](/advanced_guides/federation/#remove-a-federation)
for user-managed router links.

...
Slot engine (sim_rgb_camera_link:v1 as viewer, one) can pair with 2 indexed nodes
  https://github.com/Peppy-bot/nodes-hub.git (ref: main):
    ...
    │ openarm_sim_isaac  │ v1  │ camera │ wrist_right (zero_or_one) │ unpinned │ openarm/sim_isaac/peppy.json5  │
    │ openarm_sim_mujoco │ v1  │ camera │ wrist_left (zero_or_one)  │ unpinned │ openarm/sim_mujoco/peppy.json5 │
    │ openarm_sim_mujoco │ v1  │ camera │ wrist_right (zero_or_one) │ unpinned │ openarm/sim_mujoco/peppy.json5 │
    └────────────────────┴─────┴────────┴───────────────────────────┴──────────┴────────────────────────────────┘
```

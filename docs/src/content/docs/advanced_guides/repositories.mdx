...
Implemented by 2 indexed nodes
  https://github.com/Peppy-bot/nodes-hub.git (ref: main):
    uvc_camera_linux  v1  slot camera  pin a4e66999 (current)  uvc_camera/linux/peppy.json5

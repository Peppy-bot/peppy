...
| [Observer slot](/advanced_guides/pairing/#observers-watching-a-pairing-without-joining-it) | `depends_on.pairing_observers` | Instances playing the observed role of the pairing | The observed pairing(s) bound to the slot, sized by its cardinality (one by default), non-exclusive, read-only |

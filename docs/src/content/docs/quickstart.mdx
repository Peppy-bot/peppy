...
![The MuJoCo viewer showing the simulated bimanual OpenArm, next to the openarm_commander panel playing the wave gesture](../../assets/mujoco_sim1.png)

...
```sh
peppy node start fake_uvc_camera:0.1.0 device_path="/dev/video1" video.encoding="rgb" video.frame_rate=30 video.resolution.width=1280 video.resolution.height=720
```
...
[2026-01-25T16:38:51.860] [stdout] [uvc_camera] Video file found: /Users/tuatini/.peppy/added_nodes/fake_uvc_camera_0.1.0_093fa9/assets/robot.mp4

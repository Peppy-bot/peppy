...
These three are not the whole story: [pairing](/advanced_guides/pairing/) covers exclusive bidirectional exchanges between two instances, and [contract conformance](/advanced_guides/contract_conformance/) lets any conforming producer fill a consumer's slot. For a side-by-side decision guide, see [Choosing a communication pattern](/advanced_guides/communication_patterns/).

...
You'll be able to connect daemon nodes from different locations into a unified network, where each daemon node manages a single robot and its components. 
...
1. Python support
2. Multi-node networking for daemon node communication
...
<details>
<summary>Will PeppyOS add support for containers?</summary>

Yes, container support is on our roadmap. We plan to focus on immutable containers and hardened images.
</details>

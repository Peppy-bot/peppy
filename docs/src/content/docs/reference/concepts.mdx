...
| `depends_on` | Optional dependency declarations on other nodes (`depends_on.nodes`) or contracts (`depends_on.contracts`); see [Contract conformance](/advanced_guides/contract_conformance) |

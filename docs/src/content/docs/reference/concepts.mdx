...
- **State**: Its runtime lifecycle state, `starting` while it comes up and then `running`
- **Health**: The result of the core node's latest liveness probe, `healthy` or `unhealthy`

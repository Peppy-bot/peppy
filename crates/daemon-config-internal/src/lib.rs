...
pub mod launcher {
    pub use crate::internal::launcher::{
        ...
        PreparedLauncher, ResolvedClocks, RunningStack, SELF_COPY_NAME_REFUSAL, Selection,
        SkipReason, SkippedAdjustment, UnitSelection, VacantReason, WALL_CLOCK, check_composition,

...
use crate::commands::node::{DEFAULT_IDLE_TIMEOUT_SECS, DEFAULT_MAX_TIMEOUT_SECS, caller_env_overrides};
...
// Absolute max timeout for the entire launch operation (2x per-operation max)
const MAX_TIMEOUT: Duration = Duration::from_secs(DEFAULT_MAX_TIMEOUT_SECS * 2);

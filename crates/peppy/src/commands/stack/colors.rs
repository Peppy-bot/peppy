...
pub(super) const TRANSPORT_SHM_COLOR: &str = "\x1b[32m"; // green — payload arrived via shared memory
pub(super) const TRANSPORT_MIXED_COLOR: &str = "\x1b[33m"; // yellow — mixed shm/network within one run

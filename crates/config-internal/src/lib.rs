...
pub mod peppy_config {
    pub use crate::internal::peppy_config::{
        ...
        DEFAULT_HIGH_THROUGHPUT_BUFFER_SIZE, DEFAULT_SHM, DEFAULT_SHM_SEGMENT_BYTES,
        DEFAULT_SHUTDOWN_GRACE_SECS, DEFAULT_STANDARD_BUFFER_SIZE, LifecycleConfig,
        MIN_DAEMON_GRACE_SECS, Mode, PEPPY_CONFIG_FILE, PeerConfig, PeppyConfig, ShmConfig,
        TransportProfile, load_or_create,
    };
}

...
mod tests {
    ...
    fn fails_when_codegen_fingerprint_mismatch() {
        ...
        let peppy_config_content = r#"{
            schema_version: 1,
            manifest: { name: "test_node", tag: "0.1.0", language: "rust", start_cmd: ["./target/debug/test_node"] },
    ...
    fn standalone_mode_uses_manifest_node_name() {
        ...
        let peppy_config_content = r#"{
            schema_version: 1,
            manifest: { name: "my_node", tag: "0.1.0", language: "rust", start_cmd: ["./target/debug/my_node"] },
            parameters: {}
        }"#;
        std::fs::write(&peppy_config_path, peppy_config_content)
            .expect("peppy config should be written");

...
///
/// This function takes a `RawNodeArguments` map (where values are type specifications like "string", "u16", etc.
...
pub fn generate_parameters_struct(parameters: &config::RawNodeArguments) -> Result<String> {
...
pub fn validate_parameter_schema(parameters: &config::RawNodeArguments) -> Result<()> {

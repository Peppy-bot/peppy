...
use common::{
    ...
    start_core_node_with_real_messenger_topology,
};
use daemon_config::peppy_config::LocalNodesTopology;
use std::time::Duration;

#[rstest::rstest]
#[case::peer(LocalNodesTopology::Peer)]
#[case::router(LocalNodesTopology::Router)]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn clock_service_round_trip_over_real_zenoh(#[case] topology: LocalNodesTopology) {
...
#[case::router(LocalNodesTopology::Router)]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn clock_topic_publishes_ticks_over_real_zenoh(#[case] topology: LocalNodesTopology) {
    let started = start_core_node_with_real_messenger_topology(topology).await;

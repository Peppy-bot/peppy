...
pub use services::{
    ...
    HostAddressSource, NAME_CLAIM_LINKED_SETTLE, TEARDOWN_REAP_BUDGET, check_runtime_prerequisites,
    checkout_dir_for, copy_removal_budget, force_kill_deadline, idle_timeout_flag,
    materialized_checkout, slow_connection_hint, stack_reset_timeout, teardown_all_instances,
};
